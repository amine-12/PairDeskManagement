...
export default {
  ...
  mounted() {
    try {
      axios.get("http://3.99.41.187:8080/features/api/tasks/" + this.$route.params.featureId, this.yourConfig).then((resp) => {
        this.list = resp.data;
      })

      axios.get("http://3.99.41.187:8080/features/api/progress/" + this.$route.params.featureId, this.yourConfig).then((resp) => {
  ...
  methods: {
    ...
    deleteTask(taskId) {
      this.$swal.fire({
        ...
        if (result.isConfirmed) {
          axios.delete('http://3.99.41.187:8080/features/api/tasks/' + taskId, this.yourConfig)
              .then((resp) => {
                this.form = resp.data;
    ...
    completeTask(id, status) {
      ...
      axios.put('http://3.99.41.187:8080/features/api/tasks/update/' + id, this.form2, this.yourConfig)
          .then((resp) => {
    ...
    prefillUpdateForm(id){
      ...
      axios.get("http://3.99.41.187:8080/features/api/task/" + this.tid2, this.yourConfig).then((resp) => {
...
// When the user clicks anywhere outside of the modal, close it
    ...
    submitForm() {
      if (this.formIsValid) {
        ...
        axios.post('http://3.99.41.187:8080/features/api/task/add', this.form, this.yourConfig)
            .then((resp) => {
              this.form = resp.data;
              console.log(this.form);
            })
    ...
    submitForm2() {
      if (this.formIsValid2) {
        ...
        axios.put('http://3.99.41.187:8080/features/api/tasks/update/' + this.tid2, this.form3, this.yourConfig)
            .then((resp) => {
              this.form3 = resp.data;
