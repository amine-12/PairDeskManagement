...
export default {
  ...
  data() {
    ...
    axios.get("http://localhost:8080/users/api/password", this.yourConfig).then((resp) => {
...
// When the user clicks anywhere outside of the modal, close it
    ...
    verifyUsername(){
      axios.post('http://localhost:8080/api/auth/existing-username/', this.form.username, this.yourConfig)
          .then((resp) => {
    ...
    verifyEmail(){
      axios.post('http://localhost:8080/api/auth/existing-email/', this.form.email, this.yourConfig)
          .then((resp) => {
