...
export default {
  ...
  mounted() {
    ...
    axios.get("http://3.99.41.187:8080/features/api/all", yourConfig).then((resp) => {
      this.list = resp.data;
    }).catch((error) => {
    ...
    axios.get("http://3.99.41.187:8080/features/api/users/" + this.user.userId, yourConfig).then((resp) => {
