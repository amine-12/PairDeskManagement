...
export default {
  ...
  data()
  {
    ...
    async mounted() {
      await axios.get("http://3.99.41.187:8080/invoices/api/user/" + this.$route.params.userId,this.yourConfig).then((resp) => {
      ...
      await axios.get("http://3.99.41.187:8080/users/api/" + this.$route.params.userId,this.yourConfig).then((resp) => {
        this.user = resp.data;
      }).catch((error) => {
        if (error.response.status === 401) {
          this.$router.push('/login')
      ...
      await axios.get("http://3.99.41.187:8080/features/api/user/completed/" + this.$route.params.userId,this.yourConfig).then((resp) => {
      ...
      await axios.get("http://3.99.41.187:8080/invoices/api/user/payout/" + this.$route.params.userId,this.yourConfig).then((resp) => {
